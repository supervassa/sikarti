            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="font-semibold text-slate-800 dark:text-slate-100 mt-0.5">{currentUser?.paket || '-'}</p>
                    </div>
                    <div>
                        <p className="text-xs text-slate-400">NIK</p>
                        <p className="font-semibold text-slate-800 dark:text-slate-100 mt-0.5">{currentUser?.nik || '-'}</p>
                    </div>
                </div>

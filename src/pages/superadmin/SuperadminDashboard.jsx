    ...
    <section className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <article className="rounded-2xl border border-emerald-100 bg-emerald-50 p-5">
          <p className="text-sm text-emerald-700">Admin aktif</p>
          <p className="mt-2 text-3xl font-bold text-emerald-900">
            {activeAdmins}
          </p>
        </article>
        <article className="rounded-2xl border border-amber-100 bg-amber-50 p-5">
          <p className="text-sm text-amber-700">Aktivitas terbaru</p>
            ...
            {logs.length === 0 ? (
              ...
              logs.map((log) => (
                <div key={log.id} className="flex gap-3 px-6 py-4">
                  <span className="mt-1 rounded-lg bg-violet-50 px-2 py-1 text-[10px] font-bold text-violet-700">
                    {log.action}
                  </span>
                  <div>

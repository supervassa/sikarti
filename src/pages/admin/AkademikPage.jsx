    ...
    <section className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">
          Kelola mata pelajaran dan jadwal kegiatan belajar per program paket.
        </p>
      </div>
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-md w-full p-6 space-y-4 shadow-xl">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">
              {editingMapelId ? "Edit" : "Tambah"} Mata Pelajaran
            </h2>
            <form onSubmit={handleMapelSubmit} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setMapelForm({ ...mapelForm, nama: e.target.value })
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setMapelForm({ ...mapelForm, paket: e.target.value })
                  }
                  className="w-full px-3 py-2 border rounded-lg text-sm outline-none focus:border-red-500 bg-transparent"
                >
      ...
      {modal === "jadwal" && (
        <div className="fixed inset-0 z-50 bg-slate-900/50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-md w-full p-6 space-y-4 shadow-xl">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">
              {editingJadwalId ? "Edit" : "Tambah"} Jadwal
            </h2>
            <form onSubmit={handleJadwalSubmit} className="space-y-3">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setJadwalForm({ ...jadwalForm, paket: e.target.value })
                  }
                  className="w-full px-3 py-2 border rounded-lg text-sm outline-none focus:border-red-500 bg-transparent"
                >
                  <option value="Paket A">Paket A (Setara SD)</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setJadwalForm({ ...jadwalForm, namaMapel: e.target.value })
                  }
                  className="w-full px-3 py-2 border rounded-lg text-sm outline-none focus:border-red-500 bg-transparent"
                >
                  <option value="">Pilih mapel...</option>
                  {mapelList
                    .filter((m) => m.paket === jadwalForm.paket)
                    .map((m) => (
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setJadwalForm({ ...jadwalForm, hari: e.target.value })
                  }
                  className="w-full px-3 py-2 border rounded-lg text-sm outline-none focus:border-red-500 bg-transparent"
                >
                  {HARI.map((h) => (
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <TimePicker
                    ...
                    onChange={(val) =>
                      setJadwalForm({ ...jadwalForm, jamMulai: val || "" })
                    }
                  />
                </div>
                <div>
                  ...
                  <TimePicker
                    ...
                    onChange={(val) =>
                      setJadwalForm({ ...jadwalForm, jamSelesai: val || "" })
                    }
                  />
                </div>
              </div>

      ...
      <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 md:pr-12">
          ...
          <p className="text-lg text-gray-600 dark:text-slate-300 mb-8 max-w-lg">
            Pusat Kegiatan Belajar Masyarakat (PKBM) KARTINI hadir untuk
            memberikan layanan pendidikan non-formal yang berkualitas, inklusif,
            dan berorientasi pada kemandirian warga belajar.
          </p>
          <Link
            to="/daftar"
            className="inline-block px-6 py-3 bg-red-600 text-white font-bold rounded-full hover:bg-red-700 shadow-lg transition-transform transform hover:-translate-y-1"
          >

      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row gap-12">
              ...
              newsList.map((item) => {
                ...
                return (
                  <Link
                    key={item.id}
                    to={`/berita/${item.id}`}
                    className="flex bg-white dark:bg-slate-800 rounded-lg shadow-sm overflow-hidden border border-gray-100 dark:border-slate-700 hover:shadow-md transition-shadow"
                  >
                    ...
                    <div className="p-4 w-2/3 flex flex-col justify-center">
                      ...
                      <h3 className="font-bold text-gray-900 dark:text-white leading-tight mb-2 line-clamp-2">
                        {item.title}
                      </h3>
        ...
        <div className="md:w-1/3">
          <div className="bg-[#f2efe9] dark:bg-slate-800 p-6 rounded-lg">
            <h3 className="font-bold text-xl text-red-700 dark:text-red-400 mb-4">
              Akses Cepat
            </h3>
            <ul className="space-y-3">
              <li className="border-b border-gray-300 dark:border-slate-600 pb-2 text-sm text-gray-700 dark:text-slate-300 hover:text-red-600 dark:hover:text-red-400 cursor-pointer">
                &gt; Kalender Akademik
              </li>
              <li className="border-b border-gray-300 dark:border-slate-600 pb-2 text-sm text-gray-700 dark:text-slate-300 hover:text-red-600 dark:hover:text-red-400 cursor-pointer">

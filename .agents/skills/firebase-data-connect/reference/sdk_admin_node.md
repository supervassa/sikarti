...
```typescript
import { initializeApp } from "config-admin/app";
import { getDataConnect } from "config-admin/data-connect";
...
```typescript
import { HttpsError, onCall } from "config-functions/https";
...
```typescript
import { getAuth } from "config-admin/auth";
import { onRequest } from "config-functions/https";
import { getMyFavoriteSongs } from "@dataconnect/admin-generated";
